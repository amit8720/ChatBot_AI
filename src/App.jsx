...
const App = () => {
  ...
  const generateResponse = async (msg) => {
    ...
    const genAI = new GoogleGenerativeAI("AIzaSyAhMkSFkQ49reeSiOZmBZNdCe0Ado4QFuI");
    ...
    <>
      <div className="container w-screen min-h-screen overflow-x-hidden bg-[#0E0E0E] text-white">
        ...
        <div className="bottom w-[100%] flex flex-col items-center">
          ...
          <p className='text-[gray] text-[14px] my-4'>ChatBot is developed by Amit Sangwan. this AI use the gemini API for giving the response  </p>
        </div>
      </div>
    </>
  )
